...
import torch
# torchvision disabled on Jetson offline
...
def non_max_suppression(prediction,
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        # simple CPU/CUDA NMS replacement without torchvision
i = []
...
i = torch.stack(i) if len(i) else torch.empty((0,), dtype=torch.long, device=boxes.device)
