...
class MAVLinkTelemetry:
            ...
            try:
                ...
                while not self._stop_event.is_set():
                    ...
                    if msg is None:
                        ...
                        with self._lock:
                            if self.connected and (time.time() - self.heartbeat_state["last_heartbeat_time"] > 5.0):
    ...
    def get_data(self):
        with self._lock:
            ...
            active = self.connected and (time.time() - self.heartbeat_state["last_heartbeat_time"] < 5.0)
